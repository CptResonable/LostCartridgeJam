...
public class Arms {
    ...
    private void Player_fixedUpdateEvent() {
        tArmControllerBase.position = character.head.tCameraBase.position;
        tArmControllerBase.rotation = Quaternion.Lerp(tArmControllerBase.rotation, character.head.tCameraBase.rotation, Time.fixedDeltaTime * 12); // Lerp towards camera forward
    }
